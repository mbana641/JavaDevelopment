...
public class ITDBinarySearchTree
{
  public static void main(String[] args) 
  {
    ...
    while (keepGoing)
    {
      ...
      System.out.println("10: count number of single parents");
		...
		switch (operation)
      {
        ...
        case 9:
        System.out.println("Leaf Count Returns: " + tree.leafCount());
        break;
        
        case 10:
        System.out.println("Single Parent Count Returns: " + tree.singleParentCount());
        break;
